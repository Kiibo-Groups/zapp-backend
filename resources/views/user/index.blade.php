                    ...
                    <div class="bottom-mini-nav">
                        <div class="row no-gutters bg-1">
                            <div class="col-12 col-lg-12 simple-navbar d-flex align-items-center justify-content-start">
                                <nav class="navbar">
                                    <a class="nav-link link" href="https://play.google.com/store/apps/details?id=com.zapp.client.app" target="_blank">Descargar Apps</a>
                                    <a class="nav-link link" href="https://www.zapplogistica.com/" target="_blank">Acerca de nosotros</a>
                                </nav>
                            </div>
                        </div>
                    </div>
