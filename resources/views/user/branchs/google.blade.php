...
<div class="row">
  <div class="form-group col-md-6">
    ...
    <input id="name_branch" class="controls form-control" name="name" required value="{{ $data->name }}" type="text" placeholder="Nombre de tu nueva sucursal">
  </div>
  ...
  <div class="form-group col-md-6">
    ...
    <input id="pac-input" class="controls form-control" name="address" required value="{{$data->address}}" type="text" placeholder="Ingresa una dirección del negocio">
  </div>

  <div class="form-group col-md-3">
    <label for="num_ext">Número Exterior</label>
    <input type="text" name="num_ext" id="num_ext" class="form-control" required placeholder="Número exterior" value="{{ $data->num_ext }}">
  </div>
  <div class="form-group col-md-3">
    <label for="num_int">Número Interior</label>
    <input type="text" name="num_int" id="num_int" class="form-control" placeholder="Número interior" value="{{ $data->num_int }}">
  </div>
